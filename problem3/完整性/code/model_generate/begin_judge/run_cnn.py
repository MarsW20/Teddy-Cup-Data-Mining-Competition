...
def train():
    ...
    with tf.name_scope("train_begin"):
...
def test():
    ...
    for i in range(num_batch):  # 逐批次处理
        ...
        # 生成预测结果
        # f1 = open("./data/cnews/test.txt","r",encoding="utf-8-sig")
        # f2 = open("result.txt","w",encoding="utf-8-sig")
        # lines = f1.readlines()
        # for k in range(len(y_pred_cls)):
        #    line = str(y_pred_cls[k])+"\t"+lines[k]
